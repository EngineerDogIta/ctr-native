...
CTR_STATIC_ASSERT_LAYOUT(sizeof(struct CsParticleConfigMeta) == 0x4);
CTR_STATIC_ASSERT_LAYOUT(sizeof(struct CsParticleConfigSpawn) == 0x4);
CTR_STATIC_ASSERT_LAYOUT(sizeof(struct CsParticleConfig) == 0xc);
...
#ifndef CTR_NATIVE
CTR_STATIC_ASSERT_LAYOUT(sizeof(struct CsOpcodeMeta) == 0x14);
CTR_STATIC_ASSERT_LAYOUT(OFFSETOF(struct CutsceneObj, frameOverrideRoot) == 0x48);
CTR_STATIC_ASSERT_LAYOUT(OFFSETOF(struct CutsceneObj, decodedOpcode) == 0x4c);
CTR_STATIC_ASSERT_LAYOUT(sizeof(struct CutsceneObj) == 0x60);
#endif
...
CTR_STATIC_ASSERT_LAYOUT(sizeof(struct CsInitMatrixEntry) == 0x20);
...
CTR_STATIC_ASSERT_LAYOUT(sizeof(struct Ovr233InitMatrixTableEntry) == 0x8);
...
CTR_STATIC_ASSERT_LAYOUT(sizeof(struct OverlayDATA_233) == 0x1818);
...
#define OVR233_LAYOUT_ASSERT(ELEMENT, OFFSET, SIZE)                         \
	CTR_STATIC_ASSERT_LAYOUT(OFFSETOF(struct OverlayRDATA_233, ELEMENT) == (OFFSET)); \
	CTR_STATIC_ASSERT_LAYOUT(sizeof(((struct OverlayRDATA_233 *)0)->ELEMENT) == (SIZE))

CTR_STATIC_ASSERT_LAYOUT(sizeof(void *) == 4);
...
CTR_STATIC_ASSERT_LAYOUT(sizeof(struct OverlayRDATA_233) == 0xbd90);
...
#define OVR233_GARAGE_ASSERT(ELEMENT, OFFSET, SIZE)                      \
	CTR_STATIC_ASSERT_LAYOUT(OFFSETOF(struct OVR233_Garage, ELEMENT) == (OFFSET)); \
	CTR_STATIC_ASSERT_LAYOUT(sizeof(((struct OVR233_Garage *)0)->ELEMENT) == (SIZE))
...
CTR_STATIC_ASSERT_LAYOUT(sizeof(struct OVR233_Garage) == 0xac);
...
#define CREDITSHEADER_GETSTRINGS(x) ((char *)x + sizeof(struct CreditsLevHeader))

#ifndef CTR_NATIVE
CTR_STATIC_ASSERT_LAYOUT(OFFSETOF(struct CreditsLevHeader, numStrings) == 0x4);
CTR_STATIC_ASSERT_LAYOUT(sizeof(struct CreditsLevHeader) == 0x8);
#endif
...
#ifndef CTR_NATIVE
CTR_STATIC_ASSERT_LAYOUT(OFFSETOF(struct CreditsObj, countdown) == 0x320);
CTR_STATIC_ASSERT_LAYOUT(OFFSETOF(struct CreditsObj, credits_posY) == 0x32c);
CTR_STATIC_ASSERT_LAYOUT(OFFSETOF(struct CreditsObj, credits_topString) == 0x330);
CTR_STATIC_ASSERT_LAYOUT(sizeof(struct CreditsObj) == 0x340);
#endif
...
#define OVR233_CREDITS_OBJ_ASSERT(ELEMENT, OFFSET, SIZE)              \
	CTR_STATIC_ASSERT_LAYOUT(OFFSETOF(struct CreditsObj, ELEMENT) == (OFFSET)); \
	CTR_STATIC_ASSERT_LAYOUT(sizeof(((struct CreditsObj *)0)->ELEMENT) == (SIZE))
...
#define OVR233_CREDITS_BSS_ASSERT(ELEMENT, OFFSET, SIZE)                      \
	CTR_STATIC_ASSERT_LAYOUT(OFFSETOF(struct Ovr233_Credits_BSS, ELEMENT) == (OFFSET)); \
	CTR_STATIC_ASSERT_LAYOUT(sizeof(((struct Ovr233_Credits_BSS *)0)->ELEMENT) == (SIZE))
...
CTR_STATIC_ASSERT_LAYOUT(sizeof(struct Ovr233_Credits_BSS) == 0x374);

#undef OVR233_CREDITS_BSS_ASSERT

#ifndef CTR_NATIVE
CTR_STATIC_ASSERT_LAYOUT(OFFSETOF(struct Ovr233_Credits_BSS, numStrings) == 0x20);
CTR_STATIC_ASSERT_LAYOUT(OFFSETOF(struct Ovr233_Credits_BSS, ptrStrings) == 0x24);
CTR_STATIC_ASSERT_LAYOUT(OFFSETOF(struct Ovr233_Credits_BSS, boolAllBlue) == 0x28);
CTR_STATIC_ASSERT_LAYOUT(OFFSETOF(struct Ovr233_Credits_BSS, creditsObj) == 0x34);
#endif
