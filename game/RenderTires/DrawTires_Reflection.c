...
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresReflectionScratch, playerCounter) == 0x34);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresReflectionScratch, wheelSprites) == 0x38);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresReflectionScratch, tireColor) == 0x3c);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresReflectionScratch, otRangeNormal) == 0x40);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresReflectionScratch, otRangeSecondary) == 0x44);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresReflectionScratch, wheelSize) == 0x48);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresReflectionScratch, vertSplit) == 0x4c);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresReflectionScratch, splitCameraY) == 0x50);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresReflectionScratch, lodThreshold) == 0x54);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresReflectionScratch, wheelLocalPairA) == 0x58);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresReflectionScratch, wheelLocalPairB) == 0x68);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresReflectionScratch, wheelLocalPairC) == 0x78);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresReflectionScratch, wheelLocalPairD) == 0x88);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresReflectionScratch, viewNormalVectors) == 0x98);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresReflectionScratch, transformedRimVectors) == 0xb8);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresReflectionScratch, tireAxisA) == 0xd8);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresReflectionScratch, tireAxisB) == 0xf8);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresReflectionScratch, projectedSxy) == 0x118);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresReflectionScratch, cornerDepthBias) == 0x128);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresReflectionScratch, jumpTable) == 0x130);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresReflectionScratch, instFlags) == 0x160);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresReflectionScratch, depthOffsetStartBytes) == 0x16c);
