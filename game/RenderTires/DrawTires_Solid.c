...
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, numPlyr) == 0x30);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, playerCounter) == 0x34);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, wheelSprites) == 0x38);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, tireColor) == 0x3c);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, otRangeNormal) == 0x40);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, otRangeSecondary) == 0x44);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, wheelSize) == 0x48);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, vertSplit) == 0x4c);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, splitCameraY) == 0x50);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, lodThreshold) == 0x54);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, wheelLocalPairA) == 0x58);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, wheelLocalPairB) == 0x68);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, wheelLocalPairC) == 0x78);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, wheelLocalPairD) == 0x88);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, viewNormalVectors) == 0x98);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, transformedRimVectors) == 0xb8);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, tireAxisA) == 0xd8);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, tireAxisB) == 0xf8);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, projectedSxy) == 0x118);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, cornerDepthBias) == 0x128);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, jumpTable) == 0x130);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, instFlags) == 0x160);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, depthOffsetStartBytes) == 0x16c);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, depthOffsetEndBytes) == 0x16e);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, otRangeStart) == 0x170);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, otRangeEnd) == 0x174);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, otRangeNormalPtr) == 0x178);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, otRangeSecondaryPtr) == 0x17c);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, otRangeStartPtr) == 0x180);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DrawTiresSolidScratch, otRangeEndPtr) == 0x184);
...
CTR_STATIC_ASSERT_LAYOUT(offsetof(POLY_FT4, u0) == 0xc);
CTR_STATIC_ASSERT_LAYOUT(offsetof(POLY_FT4, x3) == 0x20);
CTR_STATIC_ASSERT_LAYOUT(sizeof(struct Instance) == 0x74);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Instance, scale) == 0x1c);
                                                                               ...
                                                                               int wheelIndex)
{
	...
	intptr_t selectedOT = scratch->otRangeNormalPtr;
	...
	if (splitDelta >= 0)
		selectedOT = scratch->otRangeSecondaryPtr;
	...
	scratch->otRangeStartPtr = DrawTiresSolid_ReadS16(scratch, 0x16c) + selectedOT;
	scratch->otRangeEndPtr = DrawTiresSolid_ReadS16(scratch, 0x16e) + selectedOT;
...
static int DrawTiresSolid_ApplyCornerOrder(struct DrawTiresSolidScratch *scratch, int jumpIndex, intptr_t *selectedOTSlot, int sxy[4])
{
	switch (jumpIndex)
	{
	case 0:
...
static void DrawTiresSolid_LinkPrimitive(struct DrawTiresSolidScratch *scratch, POLY_FT4 *p, intptr_t selectedOTSlot)
{
	uint32_t *otSlot;
                                             ...
                                             int *primCount)
{
	...
	*(u32 *)&p->r0 = scratch->tireColor;
	...
	if (scratch->otRangeSecondaryPtr == selected->selectedOT && (scratch->instFlags & 0x4000) != 0)
		return 0;
